...
class ServiciosController extends Controller
{
    ...
    $request->validate([
        ...
        'f_presentacion_req_inicio' => 'required|date',
        'f_presentacion_req_fin' => 'required|date|after_or_equal:f_presentacion_req_inicio',

        'f_designacion_cotizador_inicio' => 'required|date',
        'f_designacion_cotizador_fin' => 'required|date|after_or_equal:f_designacion_cotizador_inicio',

        'f_estudio_mercado_inicio' => 'required|date',
        'f_estudio_mercado_fin' => 'required|date|after_or_equal:f_estudio_mercado_inicio',

        'f_cuadro_comparativo_inicio' => 'required|date',
        'f_cuadro_comparativo_fin' => 'required|date|after_or_equal:f_cuadro_comparativo_inicio',

        'f_elaboracion_certificado_inicio' => 'required|date',
        'f_elaboracion_certificado_fin' => 'required|date|after_or_equal:f_elaboracion_certificado_inicio',

        'f_orden_servicio_inicio' => 'required|date',
        'f_orden_servicio_fin' => 'required|date|after_or_equal:f_orden_servicio_inicio',

        'f_notificacion_inicio' => 'required|date',
        'f_notificacion_fin' => 'required|date|after_or_equal:f_notificacion_inicio',

        'f_retorno_SGEP_inicio' => 'required|date',
        'f_retorno_SGEP_fin' => 'required|date|after_or_equal:f_retorno_SGEP_inicio',
        
        'f_mesa_partes_inicio'  => 'required|date',
        'fecha_derivar_proyectista'  => 'required|date',
        'fecha_informe_conformidad'  => 'required|date',
        'fecha_SGEP_administracion'  => 'required|date',
        ...
        'nombre_servicio.required' => 'El campo del nombre es Obligatorio',
