              ...
              <div class="row">
                <div class="col-12">
                  ...
                  <div class="form-outline mb-4">
                    ...
                    <input type="number" class="input-auth" value="0" name="porcentajeAvanceFase"
                      required min="0" max="100" step="0.01">
                    <span class="input-group-text">%</span>
                  </div>
                </div>
                <div class="col-12 py-2 text-center">
                  <button class="btn btn-primary mx-1" data-dismiss="modal"><i class="fas fa-undo-alt"></i>&nbsp;&nbsp;
                    Volver</button>
                  <button type="submit" class="btn btn-success mx-1"><i class="fas fa-plus"></i>&nbsp;&nbsp;
                    Agregar</button>
                </div>
              </div>
              <div class="col-12 py-2 text-center">
