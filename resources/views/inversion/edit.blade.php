...
@section('title', 'Editar Inversion')

@section('content_header')
  <h1><i class="fas fa-users-cog"></i> Editar "{{ $inversion->nombreInversion }}"</h1>
@stop
            ...
            <div class="row">
              ...
              <div class="col-12">
                ...
                <div class="col-6 d-flex align-items-center">
                  <div class="form-check" style="margin-right: 20px;"> <!-- Establece un margen específico -->
