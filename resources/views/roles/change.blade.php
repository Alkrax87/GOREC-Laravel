        ...
        <div class="modal-body text-center">
          ...
          <div class="row">
            <div class="col-12 pt-3 text-center">
              <button type="button" class="btn btn-primary mx-1" data-dismiss="modal"><i class="fas fa-undo-alt"></i>&nbsp;&nbsp; Volver</button>
              <button type="submit" class="btn btn-danger mx-1"><i class="fas fa-trash-alt"></i>&nbsp;&nbsp; Aceptar</button>
            </div>
          </div>
        </div>
      </div>
