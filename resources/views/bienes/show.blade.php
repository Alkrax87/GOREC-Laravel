      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha inicio :</b>&nbsp; {{ $bien->f_presentacion_req_inicio_bs}}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin :</b>&nbsp; {{ $bien->f_presentacion_req_fin_bs }}
          </div>
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha inicio :</b>&nbsp; {{ $bien->f_designacion_cotizador_inicio_bs }}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin :</b>&nbsp; {{ $bien->f_designacion_cotizador_fin_bs}}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha inicio :</b>&nbsp; {{ $bien->f_estudio_mercado_inicio_bs}}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin:</b>&nbsp; {{ $bien->f_estudio_mercado_fin_bs }}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha inicio:</b>&nbsp; {{ $bien->f_cuadro_comparativo_inicio_bs }}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin:</b>&nbsp; {{ $bien->f_cuadro_comparativo_fin_bs }}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha inicio:</b>&nbsp; {{ $bien->f_elaboracion_certificado_inicio_bs }}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin:</b>&nbsp; {{ $bien->f_elaboracion_certificado_fin_bs }}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i>  Fecha inicio:</b>&nbsp; {{ $bien->f_numero_Siaf_inicio_bs}}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin:</b>&nbsp; {{ $bien->f_numero_Siaf_fin_bs }}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i>  Fecha inicio:</b>&nbsp; {{ $bien->f_orden_compra_inicio_bs}}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin:</b>&nbsp; {{ $bien->f_orden_compra_fin_bs }}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha inicio:</b>&nbsp; {{ $bien->f_notificacion_inicio_bs}}
          </div>
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha fin:</b>&nbsp; {{ $bien->f_notificacion_fin_bs}}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha:</b>&nbsp; {{ $bien->fecha_plazo_ejecucion_bs}}
          </div>
          <div class="col-2 py-2">
          ...
          <div class="col-5 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha:</b>&nbsp; {{ $bien->fecha_ampliacion_plazo_bs }}
          </div>
          <div class="col-2 py-2">
          ...
          @if ($bien->fecha_carta_desestimiento_bs)
            <div class="col-12 py-2">
              <b><i class="fas fa-calendar-alt"></i> Carta de Desestimiento:</b>&nbsp; {{ $bien->fecha_carta_desestimiento_bs }}
            </div>
          @endif
          <div class="row">
            <div class="col-5 py-2">
              <b><i class="fas fa-calendar-alt"></i> Entrega Bien:</b>&nbsp; {{ \Carbon\Carbon::parse($bien->f_entrega_bien_inicio_bs)->format('d/m/Y') }}
            </div>
            <div class="col-5 py-2">
              <b><i class="fas fa-calendar-alt"></i> Recepcion Bien:</b>&nbsp; {{ $bien->f_recepcion_bien_inicio_bs }}
            </div>
          </div>
          <div class="col-12 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha Patrimonizacion:</b>&nbsp; {{ $bien->fecha_patrimonizacion_bs }}
          </div>
          ...
          <div class="col-6 py-2">
            <b><i class="fas fa-calendar-alt"></i> Fecha:</b>&nbsp; {{ $bien->fecha_SGASA_penalidad_bs}}
          </div>
          <div class="col-6 py-2">
